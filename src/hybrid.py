...
Bonus 2: Reciprocal Rank Fusion (RRF) combining sparse BM25 and dense
embeddings.
"""
...
class HybridRetriever:
    """Combines BM25 and vector embeddings rankings using Reciprocal
    Rank Fusion (RRF)."""
    ...
    def __init__(
        ...
        """Initialize hybrid retriever with lexical and optional
        semantic indexers."""
    ...
    def retrieve(
        ...
        """Retrieve top-k sources using RRF hybrid fusion or
        standalone BM25."""
        ...
        if not use_hybrid or self.vector_indexer is None:
            return [
                self.bm25_indexer.corpus[doc_id]
